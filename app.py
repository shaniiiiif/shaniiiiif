...
REDIRECT_URI = 'http://localhost:9456/oauth2callback' # Flask Server പോർട്ട് ഉപയോഗിക്കുന്നു
...
def load_api_key():
    ...
    if os.path.exists(API_KEY_FILE):
        try:
            ...
            pass
    return "AIzaSyDMBLzWWs2rrYHekC4yg3Dn9HeQl9PnAbw" # Replace with your default key if needed
...
# --- HTML Template ---
# ... (HTML_TEMPLATE കോഡ് അതേപടി നിലനിർത്തുക)
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="ml">
<head>
...
# --- UTILITY FUNCTIONS ---
# ... (UTILITY FUNCTIONS കോഡ് അതേപടി നിലനിർത്തുക)
...
# ... (FILE ANALYSIS FUNCTIONS കോഡ് അതേപടി നിലനിർത്തുക)
...
def run_server():
    ...
    # webbrowser.open(f'[http://127.0.0.1](http://127.0.0.1):{port}') # Render-ൽ ഇത് ഒഴിവാക്കുന്നതാണ് നല്ലത്
