...
REDIRECT_URI =  'https://shaniiiiif-7.onrender.com/oauth2callback' # <--- ഇവിടെയാണ് മാറ്റം വരുത്തിയിരിക്കുന്നത്. പുതിയ Render URL!
...
def load_api_key():
    ...
    if os.path.exists(API_KEY_FILE):
        try:
            ...
            pass
    return "AIzaSyDYaOVzYtIgr9tY8tejDyI0_tECC9Tt8vU" # Replace with your default key if needed
...
# Fixed TTS URL Error (Removed incorrect link and pointed to standard API)
TTS_API_URL = API_URL 
